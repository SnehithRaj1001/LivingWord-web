...
export default async function SignupPage({
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 py-12 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#C59B27]/10 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-[#5B7566]/10 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="relative z-10 w-full max-w-md space-y-8">
        <div className="text-center space-y-2">
          ...
          <h2 className="font-serif text-xl font-medium text-[#665C52]">Create your notebook account</h2>
        </div>
        ...
        <div className="parchment-card p-10 space-y-8">
          ...
          <div className="pt-6 border-t border-[--border-subtle] text-center">
            <p className="text-sm text-[#665C52]">
              ...
              <Link href="/login" className="text-[#C59B27] hover:text-[#B8941F] font-bold transition-colors">
                Sign in
              </Link>
            </p>
          </div>
